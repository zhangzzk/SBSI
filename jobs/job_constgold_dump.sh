#!/bin/bash
#SBATCH --job-name=cg_dump
#SBATCH --time=03:00:00
#SBATCH --mem=64G
#SBATCH --cpus-per-task=8
#SBATCH --gpus-per-node=1
#SBATCH --partition=inter
#SBATCH --output=/home/z/Zekang.Zhang/logs/cg_dump_%j.out
...
echo "### CONSTGOLD DUMP  model=$MODEL  (RAW baseline + per-object dump) ###"; date
