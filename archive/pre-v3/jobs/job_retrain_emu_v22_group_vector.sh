#!/bin/bash
#SBATCH --job-name=emu_v22_groupvec
#SBATCH --time=03:30:00
#SBATCH --mem=64G
#SBATCH --cpus-per-task=8
#SBATCH --partition=cluster
#SBATCH --constraint=x86-64-v3
#SBATCH --output=/home/z/Zekang.Zhang/logs/emu_v22_groupvec_%j.out
#SBATCH --error=/home/z/Zekang.Zhang/logs/emu_v22_groupvec_%j.err
set -euo pipefail
