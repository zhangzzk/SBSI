#!/bin/bash
#SBATCH --job-name=abrep2_groupvec
...
#SBATCH --output=/home/z/Zekang.Zhang/logs/abrep2_groupvec_%A_%a.out
#SBATCH --error=/home/z/Zekang.Zhang/logs/abrep2_groupvec_%A_%a.err
set -euo pipefail
...
PARTS=/project/ls-gruen/users/zekang.zhang/sbsi_gap_anchor_groupvec_c400-599
