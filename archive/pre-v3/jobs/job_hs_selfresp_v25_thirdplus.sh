...
#SBATCH --array=0-3
#SBATCH --output=/home/z/Zekang.Zhang/logs/hsv25tp_%A_%a.out
set -euo pipefail
...
CK=/project/ls-gruen/users/zekang.zhang/sbsi_caches/ablation/measurement_flow_g0_ngmix_ablate_s2c_lt500_v25_thirdplus_target_s${SD}_swaavg.pt
CACHE=/project/ls-gruen/users/zekang.zhang/sbsi_caches/hs_selfresp_v23_thirdplus_c40-199/base_c40-199.feather
OUTDIR=/project/ls-gruen/users/zekang.zhang/sbsi_caches/hs_selfresp_v25_thirdplus_target_c40-199
...
echo HS_V25_THIRDPLUS_TASK_DONE; date
