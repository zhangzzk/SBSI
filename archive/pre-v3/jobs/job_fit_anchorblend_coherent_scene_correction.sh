#!/bin/bash
#SBATCH --job-name=ab_cohscene
#SBATCH --time=01:00:00
#SBATCH --mem=48G
#SBATCH --cpus-per-task=8
#SBATCH --partition=cluster
#SBATCH --constraint=x86-64-v3
#SBATCH --output=/home/z/Zekang.Zhang/logs/ab_cohscene_%j.out
#SBATCH --error=/home/z/Zekang.Zhang/logs/ab_cohscene_%j.err
set -euo pipefail
...
python -u scripts/fit_anchorblend_coherent_scene_correction.py \
  ...
  --output results/anchorblend_coherent_scene_correction_v22_c0-299.json
