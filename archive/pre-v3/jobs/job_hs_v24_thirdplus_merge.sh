#!/bin/bash
#SBATCH --job-name=hsv24merge
#SBATCH --time=01:00:00
#SBATCH --mem=96G
#SBATCH --cpus-per-task=4
#SBATCH --partition=cluster
#SBATCH --constraint=x86-64-v3
#SBATCH --output=/home/z/Zekang.Zhang/logs/hsv24merge_%j.out
set -euo pipefail
...
OUT=$OUTDIR/halfshear_selfresp_v24_thirdplus_target_c40-199.feather
...
echo HS_V24_THIRDPLUS_MERGE_DONE; date
