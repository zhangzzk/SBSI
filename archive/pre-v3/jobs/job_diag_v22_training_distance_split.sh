#!/bin/bash
#SBATCH --job-name=v22trd23
#SBATCH --time=01:00:00
#SBATCH --mem=40G
#SBATCH --cpus-per-task=8
#SBATCH --partition=cluster
#SBATCH --constraint=x86-64-v3
#SBATCH --output=/home/z/Zekang.Zhang/logs/v22trd23_%j.out
#SBATCH --error=/home/z/Zekang.Zhang/logs/v22trd23_%j.err
set -euo pipefail

ROOT=/home/z/Zekang.Zhang/SBSI/.claude/worktrees/selbias-plot
PY=/project/ls-gruen/users/zekang.zhang/envs/py31/bin/python
OUT=$ROOT/results/v22_summed_label_distance_split_c40-199.json
...
"$PY" -u scripts/diag_v22_summed_label_closure.py \
  ...
  --v21-domain --split-distance 2 3 --output "$OUT"
echo V22_TRAINING_DISTANCE_SPLIT_JOB_DONE
