#!/bin/bash
#SBATCH --job-name=v26fluxcmp
#SBATCH --time=01:30:00
#SBATCH --mem=220G
#SBATCH --cpus-per-task=8
#SBATCH --partition=cluster
#SBATCH --constraint=x86-64-v3
#SBATCH --output=/home/z/Zekang.Zhang/logs/v26fluxcmp_%j.out
set -euo pipefail
...
"$PY" -u scripts/diag_v22_neighbor_flux.py \
  ...
  --expect-seeds 6 --catalogue "$CAT" --flux-lookup "$LOOKUP" \
  --min-case 40 --mag-max 25.8 --re-min 0.5
echo V26_V22_NEIGHBOR_FLUX_COMPARE_DONE; date
