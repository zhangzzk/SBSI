...
OUT=$ROOT/results/v22_pair_residual_parametric_transfer_anchor_g002_c400-899
...
python -u scripts/apply_v22_pair_residual_calibration_coherent.py \
  ...
  --output-prefix "$OUT"
echo V22_PAIR_RESIDUAL_CALIBRATION_COHERENT_JOB_DONE
date
