...
#SBATCH --output=/home/z/Zekang.Zhang/logs/v22dc_shape_%A_%a.out
#SBATCH --error=/home/z/Zekang.Zhang/logs/v22dc_shape_%A_%a.err
...
echo "V22_MATCHED_DECOMP_PILOT_SHAPE_DONE mode=$MODE"
