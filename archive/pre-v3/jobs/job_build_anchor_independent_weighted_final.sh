...
#SBATCH --array=0-2%3
#SBATCH --output=/home/z/Zekang.Zhang/logs/ab_indrpow3_%A_%a.out
#SBATCH --error=/home/z/Zekang.Zhang/logs/ab_indrpow3_%A_%a.err
set -euo pipefail
...
echo "ANCHOR_INDEPENDENT_WEIGHTED_FINAL_BUILD_DONE tag=$TAG"
