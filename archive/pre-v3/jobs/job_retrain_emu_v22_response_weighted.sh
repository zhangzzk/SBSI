#!/bin/bash
#SBATCH --job-name=emu_v22_rpow
#SBATCH --time=01:00:00
#SBATCH --mem=48G
#SBATCH --cpus-per-task=8
#SBATCH --partition=cluster
#SBATCH --array=0-2%3
#SBATCH --output=/home/z/Zekang.Zhang/logs/emu_v22_rpow_%A_%a.out
set -euo pipefail
...
case "$SLURM_ARRAY_TASK_ID" in
  0) export RESPONSE_WEIGHT_ALPHA=0.3 RESPONSE_WEIGHT_TOKEN=a03 ;;
  1) export RESPONSE_WEIGHT_ALPHA=1.0 RESPONSE_WEIGHT_TOKEN=a10 ;;
  2) export RESPONSE_WEIGHT_ALPHA=3.0 RESPONSE_WEIGHT_TOKEN=a30 ;;
