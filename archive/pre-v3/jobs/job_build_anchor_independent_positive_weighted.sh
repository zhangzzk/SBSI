...
#SBATCH --array=0-2%3
#SBATCH --output=/home/z/Zekang.Zhang/logs/ab_indpos3_%A_%a.out
#SBATCH --error=/home/z/Zekang.Zhang/logs/ab_indpos3_%A_%a.err
set -euo pipefail
...
echo "ANCHOR_INDEPENDENT_POSITIVE_WEIGHTED_BUILD_DONE tag=$TAG"
