#!/usr/bin/env bash
# Freeze one million matched Infer V1 likelihood mocks on the default FS2 prior.

#SBATCH --job-name=sbsi_infer_v1_n1m_prep
...
exec env \
  ...
  N_DETECTED=1000000 INJECTED_G1=0.02 INJECTED_G2=0.0 \
