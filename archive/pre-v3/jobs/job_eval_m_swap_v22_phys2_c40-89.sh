...
OUT="$ROOT/results/constgold_m_swap_v22_phys2_16seed_c40-89.json"
...
echo "### V2.2 PHYS2 CONSTGOLD M EVALUATION job=$SLURM_JOB_ID cases=40-89 seeds=16 ###"
date
