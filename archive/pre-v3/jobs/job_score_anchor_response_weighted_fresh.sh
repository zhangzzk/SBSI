...
#SBATCH --output=/home/z/Zekang.Zhang/logs/abfr_rpow_%A_%a.out
#SBATCH --error=/home/z/Zekang.Zhang/logs/abfr_rpow_%A_%a.err
set -euo pipefail
...
PARTS=/project/ls-gruen/users/zekang.zhang/sbsi_gap_anchor_rpow_c300-399
MODEL_INDEX=$((SLURM_ARRAY_TASK_ID / 20))
BLOCK=$((SLURM_ARRAY_TASK_ID % 20))
case "$MODEL_INDEX" in
  0) TAG=lsst_r_extnbr_v22_rpowa03 ;;
  1) TAG=lsst_r_extnbr_v22_rpowa10 ;;
  2) TAG=lsst_r_extnbr_v22_rpowa30 ;;
...
echo "ANCHOR_RESPONSE_WEIGHTED_FRESH_PART_DONE tag=$TAG cases=$START-$END"
