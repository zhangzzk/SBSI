...
#SBATCH --output=/home/z/Zekang.Zhang/logs/v22q3_shape_%A_%a.out
#SBATCH --error=/home/z/Zekang.Zhang/logs/v22q3_shape_%A_%a.err

set -euo pipefail
ROOT=/home/z/Zekang.Zhang/SBSI/.claude/worktrees/selbias-plot
BE=/home/z/Zekang.Zhang/blendemu
PY=/project/ls-gruen/users/zekang.zhang/envs/sims1/bin/python
CFG=$ROOT/configs/fs2_lsst_r_v22_constgold_q3_decomp_pilot.yaml
...
cd "$BE/scripts"
"$PY" -u run_pipeline.py --config "$CFG" --steps 3 --n-mpi 64 \
  --output-path "${PREFIX}_${MODE}"
echo "V22_CONSTGOLD_Q3_DECOMP_PILOT_SHAPE_DONE mode=$MODE"
