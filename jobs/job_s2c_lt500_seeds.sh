...
#SBATCH --output=/home/z/Zekang.Zhang/logs/s2c_lt500_s%a_%j.out

# lt=500 coupling model, seeds 502/503 (501 already trained) -> 3-seed confirm ensemble.
...
echo "### S2C lt=$LT seed=$SEED ###"; nvidia-smi -L; date
