#!/bin/bash
#SBATCH --job-name=v30nsaud
#SBATCH --time=02:00:00
#SBATCH --mem=160G
#SBATCH --cpus-per-task=8
#SBATCH --partition=cluster
#SBATCH --constraint=x86-64-v3
#SBATCH --output=/home/z/Zekang.Zhang/logs/v30nsaud_%j.out
set -euo pipefail
...
T10=results/v30_rblend_mag10_nosize_c16_target.npz
T12=results/v30_rblend_mag12_nosize_c16_target.npz
COUNT_JSON=results/v30_rblend_nosize_grid_counts.json
COUNT_CSV=results/v30_rblend_nosize_grid_counts.csv
STABLE_JSON=results/v30_rblend_nosize_grid_stability.json
STABLE_CSV=results/v30_rblend_nosize_grid_stability.csv
...
echo "### V3.0 NO-SIZE GRID COUNT/STABILITY AUDIT — NO TRAINING, NO CONSTGOLD ###"; date
"$PY" -u scripts/summarize_v30_tail_grids.py \
  --target mag10_c16="$T10" --target mag12_c16="$T12" \
...
echo V30_NOSIZE_GRID_AUDIT_DONE; date
