...
#SBATCH --output=/home/z/Zekang.Zhang/logs/abep_shape_%A_%a.out
#SBATCH --error=/home/z/Zekang.Zhang/logs/abep_shape_%A_%a.err
set -euo pipefail
...
echo "ANCHORBLEND_EACHPAIR_G1_SHAPE_DONE rank=$TASK"
date
