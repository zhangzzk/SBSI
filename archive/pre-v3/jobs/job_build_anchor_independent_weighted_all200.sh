#!/bin/bash
#SBATCH --job-name=ab_indall200
#SBATCH --time=01:00:00
#SBATCH --mem=40G
#SBATCH --cpus-per-task=8
#SBATCH --partition=cluster
#SBATCH --constraint=x86-64-v3
#SBATCH --output=/home/z/Zekang.Zhang/logs/ab_indall200_%j.out
#SBATCH --error=/home/z/Zekang.Zhang/logs/ab_indall200_%j.err
set -euo pipefail
...
echo ANCHOR_INDEPENDENT_WEIGHTED_ALL200_BUILD_DONE
