#!/bin/bash
#SBATCH --job-name=v24tpdiag
#SBATCH --time=01:00:00
#SBATCH --mem=96G
#SBATCH --cpus-per-task=8
#SBATCH --partition=cluster
#SBATCH --constraint=x86-64-v3
#SBATCH --output=/home/z/Zekang.Zhang/logs/v24tpdiag_%j.out
set -euo pipefail
...
SELF=/project/ls-gruen/users/zekang.zhang/sbsi_caches/hs_selfresp_v24_thirdplus_target_c40-199/halfshear_selfresp_v24_thirdplus_target_c40-199.feather
...
echo V24_THIRDPLUS_HALFSHEAR_DIAG_DONE; date
