...
#SBATCH --output=/home/z/Zekang.Zhang/logs/abfr_rpow3_%A_%a.out
#SBATCH --error=/home/z/Zekang.Zhang/logs/abfr_rpow3_%A_%a.err
set -euo pipefail
...
PARTS=/project/ls-gruen/users/zekang.zhang/sbsi_gap_anchor_rpow_final_c300-399
...
echo "ANCHOR_RESPONSE_WEIGHTED_FINAL_FRESH_PART_DONE tag=$TAG cases=$START-$END"
