...
#SBATCH --output=/home/z/Zekang.Zhang/logs/v22rk_sim_%A_%a.%N.out
#SBATCH --error=/home/z/Zekang.Zhang/logs/v22rk_sim_%A_%a.%N.err
...
echo "V22_MATCHED_RANKPILOT_SIM_DONE mode=$MODE"
