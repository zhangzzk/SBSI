#!/bin/bash
#SBATCH --job-name=v22_pos_a020
#SBATCH --time=01:00:00
#SBATCH --mem=48G
#SBATCH --cpus-per-task=8
#SBATCH --partition=cluster
#SBATCH --output=/home/z/Zekang.Zhang/logs/v22_pos_a020_%j.out
#SBATCH --error=/home/z/Zekang.Zhang/logs/v22_pos_a020_%j.err
set -euo pipefail
...
export RESPONSE_WEIGHT_ALPHA=0.20
export RESPONSE_WEIGHT_TOKEN=posw0200
cd "$ROOT"
