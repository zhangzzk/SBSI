...
OUT=$ROOT/results/v22_pair_residual_cubic_spline_transfer_anchor_g002_c400-899
...
python -u scripts/apply_v22_pair_residual_calibration_coherent.py \
  ...
  --output-prefix "$OUT"
echo V22_PAIR_RESIDUAL_CUBIC_SPLINE_COHERENT_JOB_DONE
date
