...
#SBATCH --array=0-3
#SBATCH --output=/home/z/Zekang.Zhang/logs/flow_v26scene_%A_%a.out
set -euo pipefail
...
echo "### V2.6 JOINT SCENE TARGET seed=$SEED job=$SLURM_JOB_ID ###"; nvidia-smi -L; date
