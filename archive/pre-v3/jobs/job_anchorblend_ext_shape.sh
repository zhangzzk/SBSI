...
#SBATCH --output=/home/z/Zekang.Zhang/logs/abx_shape_%j.out
#SBATCH --error=/home/z/Zekang.Zhang/logs/abx_shape_%j.err
set -euo pipefail
...
python -u run_pipeline.py --config /home/z/Zekang.Zhang/SBSI/.claude/worktrees/selbias-plot/configs/fs2_lsst_r_anchorblend_g005_ext.yaml --steps 3 --n-mpi 100
echo ANCHORBLEND_EXT_SHAPE_DONE
