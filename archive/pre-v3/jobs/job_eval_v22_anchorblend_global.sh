#!/bin/bash
#SBATCH --job-name=v22_abglob
#SBATCH --time=03:00:00
#SBATCH --mem=100G
#SBATCH --cpus-per-task=8
#SBATCH --partition=cluster
#SBATCH --constraint=x86-64-v3
#SBATCH --output=/home/z/Zekang.Zhang/logs/v22_abglob_%j.out
set -euo pipefail
...
OUT=results/v22_anchorblend_global_constgold_c40-139_s16.json
export PYTHONPATH="$ROOT:${PYTHONPATH:-}"
cd "$ROOT"

[ ! -e "$OUT" ] || { echo "REFUSING existing $OUT"; exit 1; }
"$PY" -u scripts/eval_v21_rblend_scale.py \
  --calibration-json results/anchorblend_g005_global_v22_c0-299.json \
...
echo V22_ANCHORBLEND_GLOBAL_CONSTGOLD_DONE; date
