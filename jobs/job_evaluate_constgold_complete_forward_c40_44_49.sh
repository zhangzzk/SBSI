#!/usr/bin/env bash
# Complete forward likelihood response on ConstGold cases 40, 44, and 49:
# the model predicts detection probabilities and measured-cut selection.

#SBATCH --job-name=sbsi_cg_complete3
#SBATCH --partition=inter
#SBATCH --gres=gpu:v100:1
#SBATCH --cpus-per-task=12
#SBATCH --mem=160G
#SBATCH --time=02:00:00
#SBATCH --output=/project/ls-gruen/users/zekang.zhang/sbsi/catalogue_prior/inference_constgold_plus_size075_n100k_m16384_v1/forward_response_complete_c40_44_49_v2/logs/%x_%j.out
#SBATCH --error=/project/ls-gruen/users/zekang.zhang/sbsi/catalogue_prior/inference_constgold_plus_size075_n100k_m16384_v1/forward_response_complete_c40_44_49_v2/logs/%x_%j.err
...
root=/project/ls-gruen/users/zekang.zhang/sbsi/catalogue_prior/inference_constgold_plus_size075_n100k_m16384_v1/forward_response_complete_c40_44_49_v2
...
cd "$repo"
exec "$python" -u -m scripts.evaluate_constgold_complete_forward_response \
