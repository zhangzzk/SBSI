...
def main(argv=None):
    ...
    if likelihood_config.get("deployment_status") == "preparation_only_pending_catalogue_density_adapter":
        raise RuntimeError("this likelihood is preparation-only: the disk density/state-major classifier adapter is not yet integrated")
