#!/bin/bash
#SBATCH --job-name=panelEbinScene
...
RUN=/project/ls-gruen/users/zekang.zhang/sbsi_caches/derisk/v22_newbase_case100_100_binned_sheared_scene_mse_v1
...
OUTPUT=$ROOT/results/anchor_case100_100_binned_scene_mse_residual_vs_raw_scene_c700-899
...
python -u scripts/plot_anchor_case100_100_panel_e.py \
  ...
  --output-stem "$OUTPUT"
echo "PLOT_ANCHOR_CASE100_100_BINNED_SCENE_MSE_DONE"
date
