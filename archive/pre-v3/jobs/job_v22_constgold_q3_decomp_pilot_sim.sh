...
#SBATCH --output=/home/z/Zekang.Zhang/logs/v22q3_sim_%A_%a.%N.out
#SBATCH --error=/home/z/Zekang.Zhang/logs/v22q3_sim_%A_%a.%N.err
...
echo "V22_CONSTGOLD_Q3_DECOMP_PILOT_SIM_DONE mode=$MODE"
