#!/bin/bash
#SBATCH --job-name=v22third
#SBATCH --time=01:30:00
#SBATCH --mem=200G
#SBATCH --cpus-per-task=8
#SBATCH --partition=cluster
#SBATCH --output=/home/z/Zekang.Zhang/logs/v22third_%j.out
set -euo pipefail
...
echo "### V2.2 CONDITIONAL THIRD-PLUS DIAGNOSTIC job=$SLURM_JOB_ID ###"; date
"$PY" -u scripts/diag_v22_thirdplus_conditional.py \
  ...
  --mag-bins 32 --other-bins 8 --min-cell 100
echo V22_THIRDPLUS_CONDITIONAL_DONE; date
