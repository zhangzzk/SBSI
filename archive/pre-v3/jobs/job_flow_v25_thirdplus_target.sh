...
#SBATCH --array=0-3
#SBATCH --output=/home/z/Zekang.Zhang/logs/flow_v25tp_%A_%a.out
set -euo pipefail
...
TAG=ablate_s2c_lt500_v25_thirdplus_target
CACHE=/project/ls-gruen/users/zekang.zhang/sbsi_caches/ablation
RESP=results/response_target_crowd_thirdplus_snc_c0-99_6x6x5cond_v25.npz
...
echo "### V2.5 DIRECT THIRD-PLUS TARGET seed=$SEED job=$SLURM_JOB_ID ###"; nvidia-smi -L; date
...
echo V25_THIRDPLUS_FLOW_DONE; date
