...
#SBATCH --output=/home/z/Zekang.Zhang/logs/sbsi_blend2.%j.out
#SBATCH --partition=cip
#SBATCH -e /home/z/Zekang.Zhang/logs/sbsi_blend2.%j.err

echo "START - blend probe 2: neighbour-feature ablation"; date
...
for M in lam300 lam1000; do
  echo; echo "########## MODEL: $M ##########"
  python -u scripts/blend_ablation.py \
