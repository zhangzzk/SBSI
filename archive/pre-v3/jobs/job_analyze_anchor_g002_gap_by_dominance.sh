#!/bin/bash
#SBATCH --job-name=abg002x_analyze
...
OUT=$ROOT/results/anchorblend_g002_gap_by_dominance_v22_c400-899.json
...
python -u scripts/analyze_anchor_g002_gap_by_dominance.py \
  ...
  --replicate-window 400 499 --output "$OUT"
echo ANCHOR_G002_GAP_BY_DOMINANCE_JOB_DONE
date
