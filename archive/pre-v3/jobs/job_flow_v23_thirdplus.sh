...
#SBATCH --array=0-3
#SBATCH --output=/home/z/Zekang.Zhang/logs/flow_v23tp_%A_%a.out
set -euo pipefail
...
TAG=ablate_s2c_lt500_v23_thirdplus
...
echo "### V2.3 THIRD-PLUS CONDITIONING seed=$SEED job=$SLURM_JOB_ID ###"; nvidia-smi -L; date
...
echo V23_THIRDPLUS_FLOW_DONE; date
