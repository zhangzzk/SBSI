#!/bin/bash
#SBATCH --job-name=snproxy
#SBATCH --time=00:30:00
#SBATCH --mem=150G
#SBATCH --cpus-per-task=16
#SBATCH --partition=cluster
#SBATCH --constraint=x86-64-v3
#SBATCH --output=/home/z/Zekang.Zhang/logs/snproxy_%j.out
...
echo "### SN PROXY CHECK job=$SLURM_JOB_ID ###"; date
python -u scripts/eval_sn_proxy_check.py 2>&1 | grep -v "module command" \
  || { echo SNPROXY_FAILED; exit 1; }
echo SNPROXY_ALL_DONE; date
