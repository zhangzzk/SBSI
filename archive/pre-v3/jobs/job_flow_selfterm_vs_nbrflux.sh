...
OUT=$ROOT/results/flow_selfterm_vs_nbrflux_c40-139_s16.json
...
python -u scripts/diag_flow_selfterm_vs_nbrflux.py \
  ...
  --variables nbr_flux_near SN Re_input_p \
  --output "$OUT"
echo FLOW_NBRFLUX_JOB_DONE; date
