...
#SBATCH --output=/home/z/Zekang.Zhang/logs/abrep2_all200_%A_%a.out
#SBATCH --error=/home/z/Zekang.Zhang/logs/abrep2_all200_%A_%a.err
set -euo pipefail
...
PARTS=/project/ls-gruen/users/zekang.zhang/sbsi_gap_anchor_rpowa0065_all200_c400-599
...
echo "ANCHOR_RESPONSE_WEIGHTED_ALL200_REP2_PART_DONE cases=$START-$END"
