#!/bin/bash
#SBATCH --job-name=ab_rvcoh
#SBATCH --time=00:30:00
#SBATCH --mem=16G
#SBATCH --cpus-per-task=2
#SBATCH --partition=cluster
#SBATCH --constraint=x86-64-v3
#SBATCH --output=/home/z/Zekang.Zhang/logs/ab_rvcoh_%j.out
#SBATCH --error=/home/z/Zekang.Zhang/logs/ab_rvcoh_%j.err
set -euo pipefail
ROOT=/home/z/Zekang.Zhang/SBSI/.claude/worktrees/selbias-plot
PY=/project/ls-gruen/users/zekang.zhang/envs/sims1/bin/python
cd "$ROOT"
"$PY" -u scripts/analyze_anchorblend_random_vs_coherent.py \
  ...
  --output results/anchorblend_random_vs_coherent_v22_c200-299.json
echo ANCHORBLEND_RANDOM_VS_COHERENT_ANALYSIS_JOB_DONE; date
