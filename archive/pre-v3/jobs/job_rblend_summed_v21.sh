...
#SBATCH --output=/home/z/Zekang.Zhang/logs/rbsum21_%j.out
...
NPZ=$E/rblend_measured_allnbr_v21dom_ap7g0.2.npz
...
python -u scripts/eval_rblend_gap_measured.py \
  ...
  --tags lsst_r_extnbr_v21 lsst_r_extnbr_indom_tuned \
