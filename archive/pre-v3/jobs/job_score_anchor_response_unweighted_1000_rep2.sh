...
#SBATCH --output=/home/z/Zekang.Zhang/logs/abrep2_t1000_%A_%a.out
#SBATCH --error=/home/z/Zekang.Zhang/logs/abrep2_t1000_%A_%a.err
set -euo pipefail
...
PARTS=/project/ls-gruen/users/zekang.zhang/sbsi_gap_anchor_unwt1000_c400-599
...
echo "ANCHOR_RESPONSE_UNWEIGHTED_1000_REP2_PART_DONE cases=$START-$END"
