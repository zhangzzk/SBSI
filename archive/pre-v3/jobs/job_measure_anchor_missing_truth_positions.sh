...
#SBATCH --output=/home/z/Zekang.Zhang/logs/ab_missingpos_%j.out
#SBATCH --error=/home/z/Zekang.Zhang/logs/ab_missingpos_%j.err
set -euo pipefail

ROOT=/home/z/Zekang.Zhang/SBSI/.claude/worktrees/selbias-plot
SIMS=/project/ls-gruen/users/zekang.zhang/envs/sims1
OUT=/project/ls-gruen/users/zekang.zhang/sbsi_gap_anchor_missing_truthpos_c200-299
...
mkdir -p "$OUT"
cd "$ROOT"
srun --ntasks=100 "$SIMS/bin/python" -u scripts/measure_anchor_missing_truth_positions.py \
...
echo ANCHOR_MISSING_TRUTHPOS_MEASUREMENT_DONE
date
