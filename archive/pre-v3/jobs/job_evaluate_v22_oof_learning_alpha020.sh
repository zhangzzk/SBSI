#!/bin/bash
#SBATCH --job-name=v22oof_eval_a020
#SBATCH --time=01:00:00
#SBATCH --mem=72G
#SBATCH --cpus-per-task=8
#SBATCH --partition=cluster
#SBATCH --output=/home/z/Zekang.Zhang/logs/v22oof_eval_a020_%j.out
#SBATCH --error=/home/z/Zekang.Zhang/logs/v22oof_eval_a020_%j.err
set -euo pipefail
...
"$PY" -u scripts/evaluate_v22_oof_learning.py \
  --cache "$CACHE" \
  --run-dir "$RUN" \
  --output-prefix results/v22_oof_conditional_learning_alpha020_c0-39
