#!/bin/bash
#SBATCH --job-name=v22oof_bmerge
#SBATCH --time=00:20:00
#SBATCH --mem=16G
#SBATCH --cpus-per-task=2
#SBATCH --partition=cluster
#SBATCH --output=/home/z/Zekang.Zhang/logs/v22oof_bmerge_%j.out
#SBATCH --error=/home/z/Zekang.Zhang/logs/v22oof_bmerge_%j.err
set -euo pipefail
...
cd "$ROOT"
"$PY" -u scripts/train_v22_oof_learning.py merge-base \
