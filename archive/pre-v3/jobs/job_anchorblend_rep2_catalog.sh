#!/bin/bash
#SBATCH --job-name=abrep2_cat
#SBATCH --time=01:30:00
#SBATCH --mem=120G
#SBATCH --cpus-per-task=8
#SBATCH --partition=cluster
#SBATCH --output=/home/z/Zekang.Zhang/logs/abrep2_cat_%j.out
#SBATCH --error=/home/z/Zekang.Zhang/logs/abrep2_cat_%j.err
set -euo pipefail
...
python -u scripts/prepare_anchorblend_catalogues.py \
  --base "$BASE" --cases $(seq 400 599) --g 0.05 --min-separation 20
...
echo ANCHORBLEND_REP2_CATALOG_DONE
date
