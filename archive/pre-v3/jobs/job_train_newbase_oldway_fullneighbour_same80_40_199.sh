...
OUTPUT=/project/ls-gruen/users/zekang.zhang/sbsi_caches/derisk/v22_newbase_oldway_fullneighbour_same80_40_199_v1
...
python -u scripts/train_newbase_oldway_fullneighbour_160_40.py \
  ...
  --fit-case-min 40 --fit-case-max 199 \
  --final-case-min 0 --final-case-max 39 \
  --scene-context full \
  --correction-split base \
  --output-dir "$OUTPUT"
echo "TRAIN_NEWBASE_OLDWAY_FULLNEIGHBOUR_SAME80_40_199_JOB_DONE"
date
