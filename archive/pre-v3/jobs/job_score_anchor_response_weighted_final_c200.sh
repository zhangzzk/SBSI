...
#SBATCH --output=/home/z/Zekang.Zhang/logs/ab_rpow3_c200_%A_%a.out
#SBATCH --error=/home/z/Zekang.Zhang/logs/ab_rpow3_c200_%A_%a.err
set -euo pipefail
...
PARTS=/project/ls-gruen/users/zekang.zhang/sbsi_gap_anchor_rpow_final_c200-299
...
echo "ANCHOR_RESPONSE_WEIGHTED_FINAL_C200_PART_DONE tag=$TAG cases=$START-$END"
