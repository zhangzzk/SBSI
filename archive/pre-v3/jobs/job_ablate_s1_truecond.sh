...
#SBATCH --output=/home/z/Zekang.Zhang/logs/ablate_s1_%j.out
...
echo "### ABLATE_S1 (true-cond) job=$SLURM_JOB_ID seeds='$SEEDS' FS=$FS TAG=$TAG LAM=$LAM ###"
nvidia-smi -L; date
...
echo "ABLATE_S1_ALL_DONE job=$SLURM_JOB_ID seeds='$SEEDS' TAG=$TAG"; date
