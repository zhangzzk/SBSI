...
#SBATCH --output=/home/z/Zekang.Zhang/logs/abrep2_regctl_%A_%a.out
#SBATCH --error=/home/z/Zekang.Zhang/logs/abrep2_regctl_%A_%a.err
set -euo pipefail
...
PARTS=/project/ls-gruen/users/zekang.zhang/sbsi_gap_anchor_regctl_c400-599
TOKENS=(unwtg0 unwtg0mc20)
MODEL_INDEX=$((SLURM_ARRAY_TASK_ID / 40))
PART_INDEX=$((SLURM_ARRAY_TASK_ID % 40))
TAG=lsst_r_extnbr_v22_rpow${TOKENS[$MODEL_INDEX]}
START=$((400 + 5 * PART_INDEX))
END=$((START + 4))
