...
#SBATCH --output=/home/z/Zekang.Zhang/logs/cgind_shape_%j.%N.out
#SBATCH --error=/home/z/Zekang.Zhang/logs/cgind_shape_%j.%N.err
...
cd "$BE/scripts"
"$PY" -u run_pipeline.py --config "$CFG" --steps 3 --n-mpi 100 \
  --case-offset "$START" --n-cases "$COUNT"
echo "CONSTGOLD_INDOMAIN_SHAPE_DONE cases=$START-$END"
