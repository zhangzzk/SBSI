#!/usr/bin/env bash
# Compare emulator and measured labels as a function of distance from the
# label pipeline's bright-neighbour rejection boundary.

#SBATCH --job-name=sbsi_corner_extrap
#SBATCH --partition=cluster
#SBATCH --constraint=x86-64-v3
#SBATCH --cpus-per-task=8
#SBATCH --mem=96G
#SBATCH --time=04:00:00
#SBATCH --output=/project/ls-gruen/users/zekang.zhang/sbsi_caches/fixed_g0_m258_r060_v2/corner_extrapolation_c0_19_v1/logs/%x_%j.out
#SBATCH --error=/project/ls-gruen/users/zekang.zhang/sbsi_caches/fixed_g0_m258_r060_v2/corner_extrapolation_c0_19_v1/logs/%x_%j.err
...
root=$v2/corner_extrapolation_c0_19_v1
...
echo "CORNER_EXTRAPOLATION_JOB_DONE output=$root/result.json"
