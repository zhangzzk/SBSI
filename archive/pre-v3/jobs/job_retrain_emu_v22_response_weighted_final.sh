#!/bin/bash
#SBATCH --job-name=emu_v22_rpow3
#SBATCH --time=01:00:00
#SBATCH --mem=48G
#SBATCH --cpus-per-task=8
#SBATCH --partition=cluster
#SBATCH --array=0-2%3
#SBATCH --output=/home/z/Zekang.Zhang/logs/emu_v22_rpow3_%A_%a.out
set -euo pipefail
...
case "$SLURM_ARRAY_TASK_ID" in
  0) export RESPONSE_WEIGHT_ALPHA=0.05 RESPONSE_WEIGHT_TOKEN=a005 ;;
  1) export RESPONSE_WEIGHT_ALPHA=0.065 RESPONSE_WEIGHT_TOKEN=a0065 ;;
  2) export RESPONSE_WEIGHT_ALPHA=0.08 RESPONSE_WEIGHT_TOKEN=a008 ;;
