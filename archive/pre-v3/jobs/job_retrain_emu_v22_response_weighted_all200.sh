#!/bin/bash
#SBATCH --job-name=emu_rpow_all200
#SBATCH --time=01:00:00
#SBATCH --mem=48G
#SBATCH --cpus-per-task=8
#SBATCH --partition=cluster
#SBATCH --constraint=x86-64-v3
#SBATCH --output=/home/z/Zekang.Zhang/logs/emu_rpow_all200_%j.out
#SBATCH --error=/home/z/Zekang.Zhang/logs/emu_rpow_all200_%j.err
set -euo pipefail
...
export RESPONSE_WEIGHT_TOKEN=a0065_all200
