...
#SBATCH --output=/home/z/Zekang.Zhang/logs/abep2_shape_%A_%a.out
#SBATCH --error=/home/z/Zekang.Zhang/logs/abep2_shape_%A_%a.err
set -euo pipefail
...
cd "$BE/scripts"
python -u run_pipeline.py --config "$CFG" --steps 3 --n-mpi 32 --output-path "$BASE"
...
echo "ANCHORBLEND_EACHPAIR_G2_SHAPE_DONE task=$TASK"
date
