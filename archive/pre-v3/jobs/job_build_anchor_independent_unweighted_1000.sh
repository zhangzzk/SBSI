#!/bin/bash
#SBATCH --job-name=ab_indt1000
#SBATCH --time=01:00:00
#SBATCH --mem=40G
#SBATCH --cpus-per-task=8
#SBATCH --partition=cluster
#SBATCH --constraint=x86-64-v3
#SBATCH --output=/home/z/Zekang.Zhang/logs/ab_indt1000_%j.out
#SBATCH --error=/home/z/Zekang.Zhang/logs/ab_indt1000_%j.err
set -euo pipefail
...
echo ANCHOR_INDEPENDENT_UNWEIGHTED_1000_BUILD_DONE
