...
#SBATCH --output=/home/z/Zekang.Zhang/logs/ablate_s0_%j.out
...
echo "### ABLATE_S0 (V1 repro) job=$SLURM_JOB_ID seeds='$SEEDS' FS=$FS TAG=$TAG LAM=$LAM ###"
nvidia-smi -L; date
...
echo "ABLATE_S0_ALL_DONE job=$SLURM_JOB_ID seeds='$SEEDS' TAG=$TAG"; date
