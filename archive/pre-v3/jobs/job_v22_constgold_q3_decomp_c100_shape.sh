...
#SBATCH --output=/home/z/Zekang.Zhang/logs/v22q3c_shape_%A_%a.out
#SBATCH --error=/home/z/Zekang.Zhang/logs/v22q3c_shape_%A_%a.err
...
echo "V22_CONSTGOLD_Q3_DECOMP_C100_SHAPE_DONE mode=$MODE cases=$START-$END"
