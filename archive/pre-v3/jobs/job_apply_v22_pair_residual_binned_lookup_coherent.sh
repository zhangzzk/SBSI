...
OUT=$ROOT/results/v22_pair_residual_binned_lookup_transfer_anchor_g002_c400-899
...
python -u scripts/apply_v22_pair_residual_calibration_coherent.py \
  ...
  --output-prefix "$OUT"
echo V22_PAIR_RESIDUAL_BINNED_LOOKUP_COHERENT_JOB_DONE
date
