...
#SBATCH --output=/home/z/Zekang.Zhang/logs/abep2_cat_%A_%a.out
#SBATCH --error=/home/z/Zekang.Zhang/logs/abep2_cat_%A_%a.err
set -euo pipefail
...
echo "ANCHORBLEND_EACHPAIR_G2_CATALOG_DONE task=$TASK"
date
