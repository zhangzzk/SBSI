#!/bin/bash
#SBATCH --job-name=v22oof_var
#SBATCH --time=01:00:00
#SBATCH --mem=72G
#SBATCH --cpus-per-task=8
#SBATCH --partition=cluster
#SBATCH --output=/home/z/Zekang.Zhang/logs/v22oof_var_%j.out
#SBATCH --error=/home/z/Zekang.Zhang/logs/v22oof_var_%j.err
set -euo pipefail
...
cd "$ROOT"
"$PY" -u scripts/train_v22_oof_learning.py variance \
