#!/bin/bash
#SBATCH --job-name=ab_oldfull_eval
...
RUN=/project/ls-gruen/users/zekang.zhang/sbsi_caches/derisk/v22_newbase_oldway_fullneighbour_160_40_v2
...
OUTPUT=$ROOT/results/v22_newbase_oldway_fullneighbour_160_40_anchor_transfer_c400-899.json
...
python -u scripts/evaluate_anchor_newbase_oldway.py \
  ...
  --output-json "$OUTPUT"
echo "EVALUATE_ANCHOR_NEWBASE_OLDWAY_FULLNEIGHBOUR_JOB_DONE"
date
