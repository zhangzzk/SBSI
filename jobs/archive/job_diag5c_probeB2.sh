#!/bin/bash
#SBATCH --job-name=diag5c_probeB2
#SBATCH --time=06:00:00
#SBATCH --mem=24G
#SBATCH --cpus-per-task=8
#SBATCH --gpus-per-node=1
#SBATCH --partition=cip
#SBATCH --output=/home/z/Zekang.Zhang/logs/diag5c_probeB2_%j.out
#
...
#       --mem=24G --cpus-per-task=8 jobs/job_diag5c_probeB2.sh
set -o pipefail
...
stdbuf -oL -eL python -u scripts/diag5c_probeB2_tail.py \
