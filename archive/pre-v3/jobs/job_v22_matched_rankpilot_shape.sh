...
#SBATCH --output=/home/z/Zekang.Zhang/logs/v22rk_shape_%A_%a.out
#SBATCH --error=/home/z/Zekang.Zhang/logs/v22rk_shape_%A_%a.err
...
echo "V22_MATCHED_RANKPILOT_SHAPE_DONE mode=$MODE"
