#!/bin/bash
#SBATCH --job-name=v26scenediag
#SBATCH --time=01:00:00
#SBATCH --mem=96G
#SBATCH --cpus-per-task=8
#SBATCH --partition=cluster
#SBATCH --constraint=x86-64-v3
#SBATCH --output=/home/z/Zekang.Zhang/logs/v26scenediag_%j.out
set -euo pipefail
...
SELF=/project/ls-gruen/users/zekang.zhang/sbsi_caches/hs_selfresp_v26_scene_target_c40-199/halfshear_selfresp_v26_scene_target_c40-199.feather
...
echo V26_SCENE_HALFSHEAR_DIAG_DONE; date
