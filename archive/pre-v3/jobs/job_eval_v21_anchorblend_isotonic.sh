#!/bin/bash
#SBATCH --job-name=v21_abiso
#SBATCH --time=02:00:00
#SBATCH --mem=80G
#SBATCH --cpus-per-task=8
#SBATCH --partition=cluster
#SBATCH --output=/home/z/Zekang.Zhang/logs/v21_abiso_%j.out
set -euo pipefail
...
python -u scripts/eval_v21_rblend_scale.py \
  --isotonic-npz results/anchorblend_g005_isotonic_refit.npz \
  --isotonic-summary results/anchorblend_g005_isotonic_refit.json \
