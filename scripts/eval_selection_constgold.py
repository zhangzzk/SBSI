...
COLS = ["case", "neighbored", "distance", "Re_input_p",
...
def report_scope(name, m, etp_i, etm_i, etp_m, etm_m, snp, snm, Re, g, sn_cuts, re_null):
    idx = np.where(m)[0]
...
def main():
    ...
    for nm, mask in scopes:
        report_scope(nm, mask, etp_i, etm_i, etp_m, etm_m, snp, snm, Re, g,
