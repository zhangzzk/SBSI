#!/bin/bash
#SBATCH --job-name=v30ns4_ana
#SBATCH --time=02:00:00
#SBATCH --mem=150G
#SBATCH --cpus-per-task=8
#SBATCH --partition=cluster
#SBATCH --constraint=x86-64-v3
#SBATCH --output=/home/z/Zekang.Zhang/logs/v30ns4_ana_%j.out
set -euo pipefail
...
OUT=results/v30_nosize_grid_fourseed_screen.json
...
"$PY" -u scripts/analyze_v27_scene_arms.py \
  ...
  --output "$OUT"
echo V30_NOSIZE_FOURSEED_ANALYZE_DONE; date
