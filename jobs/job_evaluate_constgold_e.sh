#!/usr/bin/env bash
# Direct antithetic ConstGold response closure for mixed-shear arm E.

#SBATCH --job-name=sbsi_e_constgold
...
output=$root/constgold_response_E_s501_c40-139.json
...
echo "CONSTGOLD_E_DONE output=$output"
