...
#SBATCH --output=/home/z/Zekang.Zhang/logs/v27sh_cg_%A_%a.%N.out
#SBATCH --error=/home/z/Zekang.Zhang/logs/v27sh_cg_%A_%a.%N.err
set -euo pipefail
...
OUT=$C/parts/shell_features_const_v27_c${START}-${END}.feather
mkdir -p "$C/parts"
...
"$PY" -u scripts/compute_shell_features_v27.py \
  ...
  --sign 0.02 --cases "${CASES[@]}" --n-jobs 10 --output "$OUT"
echo V27_SIXSHELL_FEATURES_CONST_DONE cases=$START-$END
