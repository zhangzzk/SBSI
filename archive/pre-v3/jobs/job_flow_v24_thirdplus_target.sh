...
#SBATCH --array=0-3
#SBATCH --output=/home/z/Zekang.Zhang/logs/flow_v24tp_%A_%a.out
set -euo pipefail
...
TAG=ablate_s2c_lt500_v24_thirdplus_target
CACHE=/project/ls-gruen/users/zekang.zhang/sbsi_caches/ablation
RESP=results/response_target_crowd_rblend_thirdplus_snc_c0-99_6x6x5x2cond_v24.npz
COUP=/home/z/Zekang.Zhang/SBSI/results/response_target_theta_coupling_rblend_c0-99_6x9x5.npz
CAT=/project/ls-gruen/users/zekang.zhang/sbsi_catalogues/det_meas_crowd_conc_thirdplus_g0.0_train_full.feather
...
echo "### V2.4 THIRD-PLUS TARGET seed=$SEED job=$SLURM_JOB_ID ###"; nvidia-smi -L; date
"$PY" -u scripts/train_measurement_model_swa_s1_truecond.py \
  ...
  --feature-set g0_meas_crowd_conc_szfl_noz_thirdplus \
...
echo V24_THIRDPLUS_FLOW_DONE; date
