...
#SBATCH --output=/home/z/Zekang.Zhang/logs/v22q3_flow_%j.out
#SBATCH --error=/home/z/Zekang.Zhang/logs/v22q3_flow_%j.err

set -euo pipefail
ROOT=/home/z/Zekang.Zhang/SBSI/.claude/worktrees/selbias-plot
PY=/project/ls-gruen/users/zekang.zhang/envs/sims1/bin/python
CACHE=/project/ls-gruen/users/zekang.zhang/sbsi_caches/ablation
IN=/project/ls-gruen/users/zekang.zhang/sbsi_caches/derisk/v22_constgold_q3_decomp_pilot_truth.feather
OUT=/project/ls-gruen/users/zekang.zhang/sbsi_caches/derisk/v22_constgold_q3_decomp_pilot_flow.feather
...
echo V22_CONSTGOLD_Q3_DECOMP_PILOT_FLOW_DONE
