...
def _flow_mu_shifts(model, D, idx):
    ...
    m = D["mask"][idx]
    return (model.mu(model.context(D["p_e1p"][idx], D["n_e1p"][idx], m)),
            model.mu(model.context(D["p_e1m"][idx], D["n_e1m"][idx], m)),
            model.mu(model.context(D["p_e2p"][idx], D["n_e2p"][idx], m)),
            model.mu(model.context(D["p_e2m"][idx], D["n_e2m"][idx], m)))
