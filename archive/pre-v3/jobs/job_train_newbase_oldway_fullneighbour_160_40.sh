...
OUTPUT=/project/ls-gruen/users/zekang.zhang/sbsi_caches/derisk/v22_newbase_oldway_fullneighbour_160_40_v2
...
python -u scripts/train_newbase_oldway_fullneighbour_160_40.py \
  ...
  --output-dir "$OUTPUT"
echo "TRAIN_NEWBASE_OLDWAY_FULLNEIGHBOUR_160_40_JOB_DONE"
date
