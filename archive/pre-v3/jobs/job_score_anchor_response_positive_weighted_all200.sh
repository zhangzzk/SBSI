#!/bin/bash
#SBATCH --job-name=abrep2_pos_a200
...
#SBATCH --output=/home/z/Zekang.Zhang/logs/abrep2_pos_a200_%A_%a.out
#SBATCH --error=/home/z/Zekang.Zhang/logs/abrep2_pos_a200_%A_%a.err
set -euo pipefail
...
PARTS=/project/ls-gruen/users/zekang.zhang/sbsi_gap_anchor_rpow_positive_all200_c400-599
...
echo "ANCHOR_RESPONSE_POSITIVE_WEIGHTED_ALL200_PART_DONE cases=$START-$END"
