...
#SBATCH --job-name=sbsi_detladder
#SBATCH --partition=inter,cip
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=64G
#SBATCH --time=08:00:00
#SBATCH --output=/project/ls-gruen/users/zekang.zhang/sbsi_caches/detection_classifier_impact_ladder_v2/logs/%x_%j.out
#SBATCH --error=/project/ls-gruen/users/zekang.zhang/sbsi_caches/detection_classifier_impact_ladder_v2/logs/%x_%j.err
...
root=/project/ls-gruen/users/zekang.zhang/sbsi_caches/detection_classifier_impact_ladder_v2
output=$root/models
