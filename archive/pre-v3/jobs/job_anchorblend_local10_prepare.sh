#!/bin/bash
#SBATCH --job-name=ab_l10prep
#SBATCH --time=01:00:00
#SBATCH --mem=24G
#SBATCH --cpus-per-task=4
#SBATCH --partition=cluster
#SBATCH --constraint=x86-64-v3
#SBATCH --output=/home/z/Zekang.Zhang/logs/ab_l10prep_%j.out
set -euo pipefail
...
"$PY" -u scripts/prepare_anchorblend_guarded_catalogues.py \
  ...
  --g 0.05 --radius 10 --min-separation 20

echo ANCHORBLEND_LOCAL10_PREP_JOB_DONE; date
