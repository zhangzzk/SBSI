#!/bin/bash
#SBATCH --job-name=posw_trainval
#SBATCH --time=00:30:00
#SBATCH --mem=32G
#SBATCH --cpus-per-task=4
#SBATCH --partition=cluster
#SBATCH --output=/home/z/Zekang.Zhang/logs/posw_trainval_%j.out
#SBATCH --error=/home/z/Zekang.Zhang/logs/posw_trainval_%j.err
set -euo pipefail

PY=/project/ls-gruen/users/zekang.zhang/envs/sims1/bin/python
ROOT=/home/z/Zekang.Zhang/SBSI/.claude/worktrees/selbias-plot
CACHE=/project/ls-gruen/users/zekang.zhang/sbsi_caches/derisk/v22_oof_learning_v1/cache
OUTPUT=$ROOT/results/v22_pair_residual_vs_prediction_weight_scan_official_validation_c40-199_overlay
