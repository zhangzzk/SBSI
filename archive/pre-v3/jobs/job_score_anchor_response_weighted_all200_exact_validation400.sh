...
#SBATCH --output=/home/z/Zekang.Zhang/logs/ab_a200x_v400_%A_%a.out
#SBATCH --error=/home/z/Zekang.Zhang/logs/ab_a200x_v400_%A_%a.err
set -euo pipefail
ROOT=/home/z/Zekang.Zhang/SBSI/.claude/worktrees/selbias-plot
ENV=/project/ls-gruen/users/zekang.zhang/envs/sims1
PARTS=/project/ls-gruen/users/zekang.zhang/sbsi_gap_anchor_rpowa0065_all200exact_c200-599
...
echo "ANCHOR_RESPONSE_WEIGHTED_ALL200EXACT_VALIDATION_PART_DONE cases=$START-$END"
