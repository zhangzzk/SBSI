...
OUT=$ROOT/results/v22_grouped_rscene_hparam_final_half_shear_c20-39
...
python -u scripts/evaluate_v22_grouped_rscene_hparam_final.py \
  ...
  --reference "$REFERENCE" --output-prefix "$OUT"
echo V22_RSCENE_HPARAM_FINAL_EVALUATION_JOB_DONE
date
