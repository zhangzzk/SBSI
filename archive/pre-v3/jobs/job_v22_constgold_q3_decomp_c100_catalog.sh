#!/bin/bash
#SBATCH --job-name=v22q3c_cat
#SBATCH --time=04:00:00
#SBATCH --mem=160G
#SBATCH --cpus-per-task=12
#SBATCH --partition=cluster
#SBATCH --constraint=x86-64-v3
#SBATCH --output=/home/z/Zekang.Zhang/logs/v22q3c_cat_%j.out
#SBATCH --error=/home/z/Zekang.Zhang/logs/v22q3c_cat_%j.err
...
echo V22_CONSTGOLD_Q3_DECOMP_C100_CATALOG_DONE
