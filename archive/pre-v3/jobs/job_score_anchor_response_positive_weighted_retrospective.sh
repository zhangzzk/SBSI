...
#SBATCH --output=/home/z/Zekang.Zhang/logs/abold_pos3_%A_%a.out
#SBATCH --error=/home/z/Zekang.Zhang/logs/abold_pos3_%A_%a.err
set -euo pipefail
ROOT=/home/z/Zekang.Zhang/SBSI/.claude/worktrees/selbias-plot
ENV=/project/ls-gruen/users/zekang.zhang/envs/sims1
PARTS=/project/ls-gruen/users/zekang.zhang/sbsi_gap_anchor_rpow_positive_c200-399
MODEL_INDEX=$((SLURM_ARRAY_TASK_ID / 40))
BLOCK_INDEX=$((SLURM_ARRAY_TASK_ID % 40))
case "$MODEL_INDEX" in
  0) TAG=lsst_r_extnbr_v22_rpowposa0065 ;;
  1) TAG=lsst_r_extnbr_v22_rpowposa010 ;;
  2) TAG=lsst_r_extnbr_v22_rpowposa015 ;;
  *) echo "unexpected model index $MODEL_INDEX"; exit 2 ;;
esac
START=$((200 + 5 * BLOCK_INDEX))
END=$((START + 4))
...
echo "ANCHOR_RESPONSE_POSITIVE_WEIGHTED_OLD_PART_DONE tag=$TAG cases=$START-$END"
