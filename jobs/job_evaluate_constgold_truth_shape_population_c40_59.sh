#!/usr/bin/env bash
# Twenty-case truth-shape response under actual versus predicted populations.

#SBATCH --job-name=sbsi_cg_Rtruth20
#SBATCH --partition=inter
#SBATCH --gres=gpu:v100:1
#SBATCH --cpus-per-task=12
#SBATCH --mem=160G
#SBATCH --time=01:00:00
#SBATCH --output=/project/ls-gruen/users/zekang.zhang/sbsi/catalogue_prior/inference_constgold_plus_size075_n100k_m16384_v1/forward_truth_shape_population_c40_59_v1/logs/%x_%j.out
#SBATCH --error=/project/ls-gruen/users/zekang.zhang/sbsi/catalogue_prior/inference_constgold_plus_size075_n100k_m16384_v1/forward_truth_shape_population_c40_59_v1/logs/%x_%j.err
...
root=/project/ls-gruen/users/zekang.zhang/sbsi/catalogue_prior/inference_constgold_plus_size075_n100k_m16384_v1/forward_truth_shape_population_c40_59_v1
...
echo "CONSTGOLD_TRUTH_SHAPE_POPULATION20_DONE output=$output"
