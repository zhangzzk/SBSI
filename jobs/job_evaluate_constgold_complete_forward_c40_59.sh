#!/usr/bin/env bash
# Complete forward likelihood response and property contours, ConstGold 40--59.

#SBATCH --job-name=sbsi_cg_complete20
...
"$python" -u -m scripts.evaluate_constgold_complete_forward_response \
  ...
  --plot-sample-seed 20260902 --device cuda
...
echo "CONSTGOLD_COMPLETE20_DONE output=$output figures=$figures"
